...
echo -e "${CYAN}"
echo "################################################################"
echo "#      Start downloading and installing plugin canpanel_1.6.1  #"
echo "################################################################"
echo -e "${NC}"

IPK_URL="https://raw.githubusercontent.com/Ham-ahmed/1202/refs/heads/main/enigma2-plugin-extensions-canpanel_1.6.1_all.ipk"
IPK_NAME="enigma2-plugin-extensions-canpanel_1.6.1_all.ipk"
