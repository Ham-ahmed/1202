...
echo -e "${CYAN}"
echo "################################################################"
echo "#     Start downloading and installing supcam oscam11943 r802  #"
echo "################################################################"
echo -e "${NC}"

IPK_URL="https://raw.githubusercontent.com/Ham-ahmed/1202/refs/heads/main/enigma2-plugin-softcams-supcam-oscam_11943-emu-r802_all.ipk"
IPK_NAME="enigma2-plugin-softcams-supcam-oscam_11943-emu-r802_all.ipk"
